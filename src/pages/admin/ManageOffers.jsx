...
export default function ManageOffers() {
  ...
  const [form, setForm] = useState({
    title: '',
    discount_text: '',
    image_url: '/assets/banner/ac-service.jpg', // Default example path
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="w-full bg-slate-950 border border-slate-700 rounded-xl p-3 pl-10 text-slate-300 focus:border-teal-500 outline-none font-mono text-xs mt-1 placeholder:text-slate-600"
                    ...
                    <p className="text-[10px] text-slate-500 mt-2 ml-1 flex items-center gap-1">
                        ℹ️ Image must be in <code className="bg-slate-800 px-1 rounded text-teal-400">public/assets/banner</code>
                    </p>
                </div>
