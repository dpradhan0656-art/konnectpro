...
const SECTIONS = [
  ...
  { title: '2. Information We Collect', content: 'We collect: (a) Account data: name, phone number, email, address when you register or book a service; (b) Location Data: precise and approximate location data to connect customers with nearby experts and track service delivery in real-time; (c) Camera & Media Data: images captured for KYC verification (Experts) and photographic proof of damaged parts/service completion to prevent fraud; (d) Payment data: processed securely by Razorpay-we do not store card details; (e) Usage data: device info, IP address, and interaction logs.' },
  ...
  { title: '5. Your Rights & Account Deletion', content: 'Under the DPDP Act, you have the right to access, correct, or request deletion of your data. Users can request permanent deletion of their account and associated data directly through the App Settings (Delete Account option) or by emailing support@kshatr.com.' },
  { title: '6. Data Security & Data Sovereignty (Data Samprabhuta)', content: 'All personal data is securely hosted on Indian servers. We strictly adhere to "Data Sovereignty", ensuring that no personal data of our Indian users is transferred, stored, or processed outside the territorial borders of India. We use industry-standard security measures including encryption and secure connections (HTTPS). Payment processing is handled by PCI-compliant partners.' },
