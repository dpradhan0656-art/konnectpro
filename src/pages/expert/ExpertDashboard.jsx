                      ...
                      <div className="flex flex-col gap-2">
                          ...
                          {job.status === 'accepted' && (
                              <div className="flex gap-2">
                                  {/* 🚀 FIX: Corrected Google Maps Link */}
