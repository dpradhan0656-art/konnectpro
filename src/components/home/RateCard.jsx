    ...
    <section className="px-4 sm:px-6 max-w-4xl mx-auto min-w-0 w-full overflow-hidden" aria-labelledby="rate-heading">
      <div className="rounded-2xl border border-slate-200/90 bg-white shadow-[0_16px_48px_-12px_rgba(15,23,42,0.1)] overflow-visible ring-1 ring-slate-100 p-5 sm:p-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <p id="rate-heading" className="text-[11px] font-bold text-blue-600 uppercase tracking-widest mb-2">
              Transparent pricing
            </p>
            <p className="text-3xl md:text-4xl font-bold text-slate-900 flex items-baseline gap-1">
              <IndianRupee size={28} className="text-blue-600" aria-hidden="true" />
              {STARTING_PRICE}
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <button
              ...
              className="min-h-[44px] px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm uppercase tracking-widest shadow-md shadow-blue-600/25 transition-all duration-300 active:scale-[0.98] flex items-center justify-center gap-2 border border-blue-500/80"
            >
